...
echo -e "${green}"
echo "Votre serveur FiveM est prêt grâce à FiveMShield.net !"
echo "Pour des solutions sécurisées et performantes, visitez : https://fivemshield.net"
echo -e "Rejoignez notre communauté Discord : discord.gg/fivemshield\n${reset}"